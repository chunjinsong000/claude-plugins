...
Track **`acc_ehpc` (production) jobs only**. `acc_debug` and
`acc_interactive` are short-lived tests — don't pollute RUNNING.tsv
with them.
...
40015112  train/quick_1n.sh  acc_ehpc  1      3-00:00:00  2026-05-05 11:33  RUNNING  234   0.4123  2026-05-06 16:30
```
...
```
JobID     Script             QoS       Nodes  Time        Submitted         Ended             State      Runtime  FinalLoss  Cause
40015112  train/quick_1n.sh  acc_ehpc  1      3-00:00:00  2026-05-05 11:33  2026-05-08 11:33  COMPLETED  3-00:00  0.0421     -
40012345  train/test_4n.sh   acc_ehpc  4      1-00:00:00  2026-05-04 22:00  2026-05-04 23:30  FAILED     1h 30m   1.234      OOM at step 234 (.err line 67)
```
...
Drop-in shell snippet for `acc_ehpc` jobs only:
...
- ❌ Track `acc_debug` jobs (too noisy; they're 2-hour tests).
